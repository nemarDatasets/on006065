...
The data are organized according to the **Brain Imaging Data Structure (BIDS)** specification, a community-driven standard for organizing neurophysiology data along with its metadata.  
For more information, see: [BIDS Specification](https://bids-specification.readthedocs.io/en/stable/)
